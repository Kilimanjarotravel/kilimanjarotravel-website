    ...
    <div className="grid gap-10 md:grid-cols-2">
      ...
      <div>
        ...
        <p className="mt-6 leading-8 text-black/70">
          Enjoy a relaxing Zanzibar beach holiday with white-sand beaches,
          warm turquoise waters, tropical sunshine, and carefully selected
          beachfront accommodation.
        </p>

        <p className="mt-4 leading-8 text-black/70">
          Spend your days swimming, relaxing, enjoying fresh seafood, and
          exploring the island at your own pace. This beach holiday is
          perfect after a safari, for couples, families, and honeymoon
          travelers.
        </p>
