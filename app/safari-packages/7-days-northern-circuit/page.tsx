...
const itinerary = [
  ...
  },
  {
    ...
    text: 'After breakfast, descend into the Ngorongoro Crater for a game drive. Search for lions, elephants, buffaloes, zebras, wildebeest, hippos, hyenas and, with luck, black rhinos. Enjoy a picnic lunch before ascending the crater and returning to Arusha.',
