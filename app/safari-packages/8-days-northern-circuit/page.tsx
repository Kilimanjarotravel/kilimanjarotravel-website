...
const translations = {
  en: {
    heroTitle: '8 Days Northern Circuit Safari',
    heroSubtitle:
      'Experience Tarangire, Lake Manyara, Serengeti and Ngorongoro on an unforgettable eight-day safari.',

    overviewLabel: 'SAFARI OVERVIEW',
    overviewTitle: 'An Extended Northern Tanzania Safari',

    paragraph1:
      "This private eight-day safari gives you extra time to explore Tanzania's famous Northern Circuit at a relaxed and comfortable pace.",

    paragraph2:
      'Visit Tarangire, Lake Manyara, Serengeti and Ngorongoro while enjoying varied landscapes, excellent wildlife viewing and extended time on the Serengeti plains.',
    ...
    day6Text:
      'Enjoy another full day exploring the Serengeti. Focus on areas with the best recent wildlife activity and continue searching for predators, large herbivore herds and other wildlife. This extra day allows more flexibility for photography and wildlife encounters.',
    day6Accommodation: 'Lodge or tented camp in Serengeti',
    day6Meals: 'Breakfast, Lunch and Dinner',

    day7: 'Day 7',
    day7Title: 'Serengeti to Ngorongoro Conservation Area',
    day7Text:
    ...
    day8: 'Day 8',
    day8Title: 'Ngorongoro Crater Safari and Return to Arusha',
    day8Text:
    ...
    day8Meals: 'Breakfast and Lunch',

    detailsTitle: 'Safari Details',

    duration: 'Duration',
    durationValue: '8 Days / 7 Nights',
    ...
    included: [
      ...
      'Seven nights lodge or tented camp accommodation',
    ...
    readyTitle: 'Ready for Your Eight-Day Safari?',
    ...
    priceRows: [
      ...
      {
        people: '2 people',
        price: 'US$3,450 per person',
      },
      {
        people: '3 people',
        price: 'US$2,900 per person',
      },
      {
        people: '4 people',
      ...
      {
        people: '5–6 people',
        price: 'US$2,290 per person',
      },
    ],
  },

  de: {
    heroTitle: '8 Tage Northern Circuit Safari',
    heroSubtitle:
      'Erleben Sie Tarangire, Lake Manyara, die Serengeti und Ngorongoro auf einer unvergesslichen achttägigen Safari.',

    overviewLabel: 'SAFARI-ÜBERSICHT',
    overviewTitle: 'Eine verlängerte Safari durch Nordtansania',

    paragraph1:
      'Diese private achttägige Safari bietet Ihnen zusätzliche Zeit, Tansanias berühmten Northern Circuit in einem entspannten und komfortablen Tempo zu erkunden.',

    paragraph2:
      'Besuchen Sie Tarangire, Lake Manyara, die Serengeti und Ngorongoro und genießen Sie abwechslungsreiche Landschaften, hervorragende Tierbeobachtungen und zusätzliche Zeit in den Ebenen der Serengeti.',
    ...
    day6Text:
      'Verbringen Sie einen weiteren vollständigen Tag mit der Erkundung der Serengeti. Konzentrieren Sie sich auf Gebiete mit der besten aktuellen Tieraktivität und halten Sie weiter Ausschau nach Raubtieren, großen Pflanzenfresserherden und anderen Wildtieren. Der zusätzliche Tag bietet mehr Flexibilität für Fotografie und Tierbeobachtungen.',
    day6Accommodation: 'Lodge oder Zeltcamp in der Serengeti',
    day6Meals: 'Frühstück, Mittagessen und Abendessen',

    day7: 'Tag 7',
    day7Title: 'Serengeti zum Ngorongoro-Schutzgebiet',
    day7Text:
    ...
    day8Text:
      'Nach einem frühen Frühstück steigen Sie für eine letzte Pirschfahrt in den Ngorongoro-Krater hinab. Halten Sie Ausschau nach Löwen, Elefanten, Büffeln, Zebras, Gnus, Flusspferden, Hyänen und mit etwas Glück nach Spitzmaulnashörnern. Genießen Sie ein Picknick, bevor Sie den Krater verlassen und am Nachmittag nach Arusha zurückkehren.',
    day8Accommodation:
      'Nach der Safari keine Unterkunft inklusive',
    day8Meals: 'Frühstück und Mittagessen',

    detailsTitle: 'Safari-Details',

    duration: 'Dauer',
    durationValue: '8 Tage / 7 Nächte',
    ...
    included: [
      ...
      'Sieben Übernachtungen in Lodge oder Zeltcamp',
    ...
    readyTitle: 'Bereit für Ihre achttägige Safari?',
    ...
    priceRows: [
      ...
      {
        people: '2 Personen',
        price: 'US$3.450 pro Person',
      },
      {
        people: '3 Personen',
        price: 'US$2.900 pro Person',
      },
      {
        people: '4 Personen',
      ...
      {
        people: '5–6 Personen',
        price: 'US$2.290 pro Person',
      },
    ],
  },

  fr: {
    heroTitle: 'Safari de 8 jours – Northern Circuit',
    heroSubtitle:
      'Découvrez Tarangire, le lac Manyara, le Serengeti et le Ngorongoro lors d’un safari inoubliable de huit jours.',

    overviewLabel: 'APERÇU DU SAFARI',
    overviewTitle: 'Un safari prolongé dans le nord de la Tanzanie',

    paragraph1:
      'Ce safari privé de huit jours vous offre davantage de temps pour explorer le célèbre circuit nord de la Tanzanie à un rythme confortable et détendu.',

    paragraph2:
      'Découvrez Tarangire, le lac Manyara, le Serengeti et le Ngorongoro tout en profitant de paysages variés, d’excellentes observations de la faune et de temps supplémentaire dans les plaines du Serengeti.',
    ...
    day6Text:
      'Profitez d’une nouvelle journée complète d’exploration du Serengeti. Concentrez-vous sur les zones où l’activité animale est la meilleure et continuez à rechercher les prédateurs, les grands troupeaux d’herbivores et d’autres animaux. Cette journée supplémentaire offre plus de flexibilité pour la photographie et les observations.',
    ...
    day8Text:
      'Après un petit-déjeuner matinal, descendez dans le cratère du Ngorongoro pour un dernier safari. Recherchez lions, éléphants, buffles, zèbres, gnous, hippopotames, hyènes et, avec un peu de chance, rhinocéros noirs. Profitez d’un déjeuner pique-nique avant de remonter du cratère et de retourner à Arusha dans l’après-midi.',
    day8Accommodation:
      'Aucun hébergement inclus après le safari',
    day8Meals: 'Petit-déjeuner et déjeuner',

    detailsTitle: 'Détails du safari',

    duration: 'Durée',
    durationValue: '8 jours / 7 nuits',
    ...
    priceNote:
      'Basé sur 5 à 6 personnes partageant. Le prix final dépend de la taille du groupe, du niveau d’hébergement, de la saison et des dates de voyage.',
    ...
    included: [
      ...
      'Sept nuits en lodge ou camp de tentes',
    ...
    readyTitle: 'Prêt pour votre safari de huit jours ?',
    ...
    priceRows: [
      ...
      {
        people: '2 personnes',
        price: '3 450 $US par personne',
      },
      {
        people: '3 personnes',
        price: '2 900 $US par personne',
      },
      {
        people: '4 personnes',
      ...
      },
      {
        ...
        price: '2 290 $US par personne',
      },
    ],
  },

  es: {
    heroTitle: 'Safari de 8 días por el Circuito Norte',
    heroSubtitle:
      'Descubre Tarangire, el lago Manyara, el Serengeti y Ngorongoro en un inolvidable safari de ocho días.',

    overviewLabel: 'RESUMEN DEL SAFARI',
    overviewTitle: 'Un safari extendido por el norte de Tanzania',

    paragraph1:
      'Este safari privado de ocho días te ofrece más tiempo para explorar el famoso Circuito Norte de Tanzania a un ritmo relajado y cómodo.',

    paragraph2:
      'Visita Tarangire, el lago Manyara, el Serengeti y Ngorongoro mientras disfrutas de paisajes variados, excelentes oportunidades para observar fauna y tiempo adicional en las llanuras del Serengeti.',
    ...
    day6Text:
      'Disfruta de otro día completo explorando el Serengeti. Concéntrate en las zonas con mayor actividad reciente de fauna y continúa buscando depredadores, grandes manadas de herbívoros y otros animales. Este día adicional ofrece más flexibilidad para la fotografía y los encuentros con la fauna.',
    ...
    day8Text:
      'Después de un desayuno temprano, desciende al Cráter del Ngorongoro para realizar un safari final. Busca leones, elefantes, búfalos, cebras, ñus, hipopótamos, hienas y, con suerte, rinocerontes negros. Disfruta de un almuerzo tipo picnic antes de ascender y regresar a Arusha por la tarde.',
    day8Accommodation:
      'No se incluye alojamiento después del safari',
    day8Meals: 'Desayuno y almuerzo',

    detailsTitle: 'Detalles del safari',

    duration: 'Duración',
    durationValue: '8 días / 7 noches',
    ...
    included: [
      ...
      'Siete noches de alojamiento en lodge o campamento',
    ...
    readyTitle: '¿Listo para tu safari de ocho días?',
    ...
    priceRows: [
      ...
      {
        people: '2 personas',
        price: 'US$3.450 por persona',
      },
      {
        people: '3 personas',
        price: 'US$2.900 por persona',
      },
      {
        people: '4 personas',
      ...
      {
        people: '5–6 personas',
        price: 'US$2.290 por persona',
      },
    ],
  },
};

export default function EightDaysNorthernCircuitPage() {
