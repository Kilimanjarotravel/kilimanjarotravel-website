...
const itinerary = [
  ...
  text: 'After an early breakfast descend into the Ngorongoro Crater for a final game drive. Enjoy a picnic lunch before returning to Arusha in the afternoon.',
  accommodation: 'None',
