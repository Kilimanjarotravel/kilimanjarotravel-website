          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="md:col-span-2">
              ...
              <h2 className="section-title mt-3">
                Five Days of Wildlife and Adventure
              </h2>

              <p className="mt-6 text-lg leading-8 text-black/70">
                This private five-day safari offers more time to explore
                Tanzania&apos;s famous Northern Circuit. Travel through
                Tarangire National Park, Serengeti National Park and the
                Ngorongoro Conservation Area.
              </p>

              <p className="mt-4 text-lg leading-8 text-black/70">
                The itinerary combines elephant-filled landscapes, classic
                Serengeti plains, predator sightings and the remarkable
                wildlife concentration of the Ngorongoro Crater.
              </p>
            ...
            <aside className="h-fit rounded-3xl bg-forest p-8 text-white shadow-xl">
              ...
              <div className="mt-8 rounded-2xl bg-gold p-5 text-center">
                ...
                <p className="mt-2 text-4xl font-bold">US$1,520</p>
      ...
      <section className="bg-forest py-20 text-white">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="font-display text-4xl font-bold md:text-5xl">
            Ready for Your Five-Day Safari?
          </h2>
