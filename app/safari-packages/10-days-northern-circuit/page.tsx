...
},
{
  day: 'Day 9',
  title: 'Serengeti to Ngorongoro Conservation Area',
  text: 'Enjoy a final morning game drive in Serengeti before traveling toward the Ngorongoro Conservation Area. Continue wildlife viewing along the way and arrive near the crater rim or Karatu for dinner and overnight.',
  accommodation: 'Lodge or tented camp near Ngorongoro or Karatu',
  meals: 'Breakfast, Lunch and Dinner',
},
{
...
export default function TenDaysNorthernCircuitPage() {
  ...
  subtitle="Explore Tarangire, Lake Manyara, Serengeti and Ngorongoro on a complete ten-day safari adventure."
