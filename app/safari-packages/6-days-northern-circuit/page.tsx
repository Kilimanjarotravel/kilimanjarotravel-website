...
const itinerary = [
  ...
  },
  {
    ...
    text: 'After breakfast, drive to Lake Manyara National Park for a game drive through groundwater forest, open woodland and lakeshore habitats. Search for elephants, giraffes, zebras, buffaloes, hippos, monkeys and abundant birdlife before continuing to your accommodation.',
    accommodation: 'Lodge or tented camp near Karatu or Lake Manyara',
  ...
  },
  {
    ...
    text: 'Travel through the Ngorongoro highlands toward Serengeti National Park. Enter the park and enjoy an afternoon game drive across the famous plains while searching for predators, large herbivore herds and other wildlife.',
  ...
  },
  {
    ...
    text: 'Spend the full day exploring Serengeti National Park. Your guide will select the best wildlife areas according to the season and recent animal movements. Enjoy morning and afternoon game drives with a picnic lunch inside the park.',
    accommodation: 'Lodge or tented camp in Serengeti',
    meals: 'Breakfast, Lunch and Dinner',
  },
  {
...
const priceRows = [
  { people: '1 person', price: 'US$4,150' },
  { people: '2 people', price: 'US$2,680 per person' },
  { people: '3 people', price: 'US$2,250 per person' },
  { people: '4 people', price: 'US$2,010 per person' },
  { people: '5–6 people', price: 'US$1,780 per person' },
];
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        subtitle="Discover Tarangire, Lake Manyara, Serengeti and Ngorongoro on a complete Northern Tanzania safari."
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="md:col-span-2">
              ...
              <p className="mt-6 text-lg leading-8 text-black/70">
                This private six-day safari offers a balanced journey through
                four of Northern Tanzania&apos;s best-known wildlife
                destinations: Tarangire, Lake Manyara, Serengeti and
                Ngorongoro.
              </p>

              <p className="mt-4 text-lg leading-8 text-black/70">
                Enjoy varied landscapes, large elephant herds, classic
                Serengeti plains, rich birdlife and a memorable game drive on
            ...
            <aside className="h-fit rounded-3xl bg-forest p-8 text-white shadow-xl">
              ...
              <div className="mt-8 rounded-2xl bg-gold p-5 text-center">
                ...
                <p className="mt-2 text-4xl font-bold">US$1,780</p>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div className="overflow-hidden rounded-3xl shadow-xl">
              <img
                ...
                alt="Six-day Northern Circuit safari"
